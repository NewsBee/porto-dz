      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-6 grid gap-5 lg:grid-cols-2">
          {featuredProjects.map((project, index) => (
            ...
            >
              <div className="relative min-h-56 border-b border-[#1F2937] bg-[#0B0F14] p-5">
                <div className="mb-4 flex items-center justify-between">
                  ...
                  <span className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.16em] text-[#64748B]">
                    <MonitorSmartphone size={15} />
                    Featured
                  </span>
                </div>

                <div className="grid h-40 grid-cols-[0.8fr_1.2fr] gap-4">
                  <div className="space-y-3">
                    ...
                    />
                    <span className="block h-3 w-24 bg-[#1F2937]" />
                    <span className="block h-3 w-16 bg-[#1F2937]" />
                    <span
                      className="block h-8 w-28"
                      style={{ backgroundColor: previewColors[index] }}
                    />
                  </div>
                  <div className="grid grid-rows-[0.7fr_1fr] gap-3">
                    <div className="border border-[#1F2937] bg-[#111821]" />
              ...
              <div className="p-6">
                <div className="mb-5 flex items-start justify-between gap-4">
                  <span className="border border-[#1F2937] bg-[#0B0F14] px-3 py-1.5 text-[11px] font-bold uppercase tracking-[0.14em] text-[#6EE7E0]">
                    {project.category}
                  </span>
                  <ArrowUpRight
                    size={22}
                ...
                <h3 className="text-2xl font-black leading-8 text-[#F8FAFC]">
                  {project.title}
                </h3>
